...
public class frmActualizar extends javax.swing.JFrame {
    ...
    public frmActualizar() {
        ...
        nombreField = new CustomRoundedTextField(SessionManager.getUsuarioActual().getNombre(), "usuario.png");
        correoField = new CustomRoundedTextField(SessionManager.getUsuarioActual().getCorreo(), "email.png");
        passField = new CustomRoundedPasswordField("Nueva contraseña", "password.png");
    ...
    private void btnAceptarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAceptarMouseClicked
        ...
        usuarioDTO.setId(SessionManager.getUsuarioActual().getId());
        ...
        if(usuario.actualizarDatos(usuarioDTO)){
